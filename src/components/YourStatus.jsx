...
import { SparklesIcon } from '@heroicons/react/24/solid'; // Import SparklesIcon for enhanced functionality
      ...
      {userData.map(user => (
        <div key={user.id} className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <Tooltip content="Enhanced AI" placement="top">
              <button className="flex items-center text-gray-500 hover:text-blue-500">
                <SparklesIcon className="h-6 w-6" /> {/* Use SparklesIcon for enhanced functionality */}
              </button>
            </Tooltip>
